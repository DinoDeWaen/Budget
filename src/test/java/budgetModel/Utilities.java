...
public class Utilities {
	...
	public static void addCashFlows(Budget budget, double[] incomeAmounts,
	...
	private static void addCashFlow(Budget budget, double[] list,
			CashFlowType type) {
	...
	private static BudgetCashFlow buildCashFlow(Double cashFlowAmount,
			CashFlowType type) {
		return cashFlow.MoneyCashFlow.newBuilder().withAmount(cashFlowAmount)
				.withType(type).withDate(new DateTime()).build();
	}
